...
print("\n\nIf you think tht the wordlists gerated is very big, please, edit de source code of the wdgen++ in script/wdgen++_for_hasher/wdgen++for_hasher.py\n\n")
